...
// Guard: imgui.h defines this operator when IMGUI_DEFINE_MATH_OPERATORS is set
// (signalled by IMGUI_DEFINE_MATH_OPERATORS_IMPLEMENTED). Only define it here
// when imgui.h hasn't already done so, to avoid MSVC C2264 redefinition errors.
